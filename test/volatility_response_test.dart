...
// tests for VolatilityResponse
void main() {
  final instance = VolatilityResponseBuilder();
  // TODO add properties to the builder and call build()

  group(VolatilityResponse, () {
    // String base_
    ...
    // String universe
    test('to test the property `universe`', () async {
      // TODO
    });
    ...
    // BuiltList<VolatilityResponseResultsInner> results
